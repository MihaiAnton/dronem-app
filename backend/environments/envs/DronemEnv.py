...
from environments.env_interpretation import Exchange
from environments.env_interpretation import MeetingEnv
from environments.env_interpretation import State
from environments.env_interpretation import env_settings
from environments.env_interpretation.action_utils import apply_action_allow_illegal
from environments.env_interpretation.action_utils import apply_action_only_increase_time_move_robots
from environments.env_interpretation.lazy_cartesian_product import LazyCartesianProduct
from environments.env_interpretation.meeting import get_valid_meetings
from environments.env_interpretation.reward_utils import OneMinusOneRewardGiverNotAllowIllegal
from environments.env_interpretation.state_utils import get_observation_from_state
from environments.env_interpretation.state_utils import get_state_from_observation
from environments.env_interpretation.utils import check_if_done
from environments.env_interpretation.utils import n_from_prod
...
class DronemEnv(gym.Env):
    ...
    def __init__(self, num_robots: int = None, max_memory: int = None, init_memory: int = None,
                 meetings: Optional[List[MeetingEnv]] = (), cycles: Optional[List[List[int]]] = ()):
        """
    ...
    def get_env_metadata(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'sets': self.__sets,
            'worst_reward': env_settings.REWARD_FOR_INVALID_ACTION,
            'max_steps': env_settings.MAXIMUM_NUM_ITER
        }
    ...
    def step(self, action: int) -> Tuple[np.array, float, bool, Dict]:
        ...
        if reward == env_settings.REWARD_FOR_INVALID_ACTION:
