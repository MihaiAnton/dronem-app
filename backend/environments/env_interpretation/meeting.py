...
from environments.env_interpretation.utils import lcm

MeetingEnv = namedtuple("Meeting", ['r1', 'r2', 'first_time'])


def get_valid_meetings(time: int, possible_meetings: List[MeetingEnv], cycle_lengths: List[int]) -> List[MeetingEnv]:
    """
